...
router.post('/', authenticateUser, authorizeAdmin, async (req, res) => {
  try {
    const { level, name, benefits, min_trading_volume, monthly_profit_ratio, commission_ratio, risk_ratio, compensation_ratio, vip_price } = req.body;
...
router.put('/:id', authenticateUser, authorizeAdmin, async (req, res) => {
  try {
    ...
    if (vip_price !== undefined) updateData.vip_price = vip_price;
